...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--training_data')
    self.parser.add_argument('--testing_data')
    self.parser.add_argument('--validation_data')

    self.parser.add_argument('--training_label')
    self.parser.add_argument('--testing_label')
    self.parser.add_argument('--validation_label')
    ...
    self.parser.add_argument('--train_pct', default=80, type=int)
    self.parser.add_argument('--val_pct', default=0, type=int)
    self.parser.add_argument('--test_pct', default=20, type=int)
    self.parser.add_argument('--label_type', default='thi',
                             help='star | box | coord | thi')
    self.parser.add_argument('--data_type', default='mrc')
    self.parser.add_argument('--load_exemplar', help='the path to the original exemplar dataset', default='./exemplar_dataset')
    self.parser.add_argument('--output_exemplar', help='the path to save the new exemplar dataset', default='./exemplar_dataset')
